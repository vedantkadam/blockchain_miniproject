      ...
      <div className="flex h-full">
        ...
        <div className="p-8 pb-4 flex-2">
          <div className="flex items-center">
            <div
              className="mr-2 text-sm font-semibold tracking-wide text-indigo-500 uppercase">
              {course.type}
            </div>
            <div>
              { state === "activated" &&
          ...
          <Link href={`/courses/${course.slug}`}>
            <a
              className="block h-12 mt-1 text-sm font-medium leading-tight text-black sm:text-base hover:underline">
              {course.title}
            </a>
          </Link>
          <p
            className="mt-2 mb-4 text-sm text-gray-500 sm:text-base">
