...
export default function Card({ course, disabled, Footer, state }) {
  return (
    <div className="overflow-hidden shadow-md bg-[#F0EAD6] rounded-xl md:max-w-2xl">
      <div className="flex h-full">
        ...
        <div className="p-8 pb-4 flex-2">
          <div className="flex items-center">
            <div className="mr-2 text-sm font-semibold tracking-wide text-red-500 uppercase">
              {course.type}
            </div>
            <div>
              {state === "purchased" && (
